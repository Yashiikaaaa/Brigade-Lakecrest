...
export const Navbar = ({ sitevisitmodal, setSiteVisitModal, setContactModal }) => {
  ...
  return (
      <div className="font-body fixed w-full z-20 top-0 start-0 bg-white shadow ">
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-0 flex flex-wrap items-center justify-between py-[8px] z-40 ">
          ...
          <div className="lg:hidden flex items-center">
            <button
              ...
              className="inline-flex items-center w-10 h-10 justify-center text-white hover:bg-skyblue2Color focus:outline-none"
          ...
          >
            <ul className="flex flex-col p-4 md:p-0 md:flex-row gap-12 w-full justify-between text-black">
