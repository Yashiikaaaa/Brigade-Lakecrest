...
export const SiteVisitForm = ({ sitevisitmodal, setSiteVisitModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const propertyId = "k221rTSnrSurbcG0tIv0"; // Example property ID
    const projectName = "assetz codename altitude"; // Example project name
  const currentAgent = "yasswanth@truestate.in";
    const payload = {
      name: normalizedName,
